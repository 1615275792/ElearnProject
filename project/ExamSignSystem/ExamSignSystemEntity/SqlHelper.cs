...
namespace CommonLibs.Utilities
{
    ...
    public class SqlHelper
    {
        ...
        /// 连接字符串
        /// </summary>
        public static string ConnString = System.Configuration.ConfigurationManager.AppSettings["conString"].ToString();
        ...
        public static bool ExecuteNonQuery(CommandType cmdType, string cmdText, SqlParameter[] cmdPrams)
        {
            // 创建连接对象，通往底层的物理数据库通道
        ...
        public static object ExecuteScalar(CommandType cmdType, string cmdText, SqlParameter[] cmdPrams)
        {
            // 创建连接对象，通往底层的物理数据库通道
            SqlConnection conn = new SqlConnection();
            conn.ConnectionString = ConnString;
